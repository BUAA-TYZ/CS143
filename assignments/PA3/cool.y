...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <class_> class
    %type <features> feature_list feature_not_empty_list
    ...
    */
    ...
    feature_list:		/* empty */
    {  $$ = nil_Features(); }
    |  feature_not_empty_list
    {  $$ = $1;  }
    ;

    feature_not_empty_list:  feature
    {  $$ = single_Features($1);  }
    |  feature_not_empty_list feature
    ...
    formal_list:  /* empty */
    {  $$ = nil_Formals();  }
    |  formal_not_empty_list
    {  $$ = $1;  }
    ;

    formal_not_empty_list:  formal
    {  $$ = single_Formals($1);  }
    |  formal_not_empty_list ',' formal
